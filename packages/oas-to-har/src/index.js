...
module.exports = (
  ...
  const proxyEnabled = extensions.extensionEnabled(oas, operation, extensions.PROXY_ENABLED);
  ...
  const userDefinedHeaders = extensions.extensionEnabled(oas, operation, extensions.HEADERS);
