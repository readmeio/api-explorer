...
describe('Image', () => {
  test('Image has a tag with property href set to url', () => {
    ...
    const imageInput = mount(<Image block={block} />);
  ...
  test('Image will render caption if given in props', () => {
    const block = { type: 'image', data: { images: [{ image: ['https://files.readme.io/924824e-fullsizeoutput_314.jpeg', 'fullsizeoutput_314.jpeg', 640, 1136, '#c8b396'], caption: 'doggo' }] }, sidebar: undefined };
    const imageInput = mount(<Image block={block} />);
