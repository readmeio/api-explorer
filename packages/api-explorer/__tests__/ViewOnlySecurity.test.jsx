...
import ViewOnlySecurity from '../src/components/ViewOnlySecurity'

describe('ViewOnlySecurity', () => {
  test('correctly invoke ReDoc for get', () => {
    const viewOnlyMode = mount(<ViewOnlySecurity components={oas.components} />)
